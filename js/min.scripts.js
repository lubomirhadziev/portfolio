    ...
    return (n = {}, s.m = i = [function(t, e, i) {
        ...
        var h = function() {
            ...
            return function(t, e, i) {
                ...
                key: "init",
                value: function() {
                    this.isInit || this.element.closest(".simpleParallax") || (!1 === this.settings.overflow && this.wrapElement(this.element), this.setStyle(), this.getElementOffset(), this.intersectionObserver(), this.getTranslateValue(), this.animate(), this.isInit = !0)
                }
            }, {
                key: "wrapElement",
                value: function() {
                ...
                key: "setStyle",
                value: function() {
                    !1 === this.settings.overflow && (this.element.style[r] = "scale(".concat(this.settings.scale, ")")), 0 < this.settings.delay && (this.element.style.transition = "transform ".concat(this.settings.delay, "s ").concat(this.settings.transition)), this.element.style.willChange = "transform"
                }
            }, {
                key: "unSetStyle",
                value: function() {
...
function initMap() {
    ...
    window.onpageshow = function(e) {
        ...
        e.find(".spinner").fadeOut(function() {
            e.fadeOut()
        }), n(".lines").addClass("finish"), setTimeout(function() {
            n(".lines").addClass("ready")
        }, 2e3), n(".typed-subtitle").length && 1 < n(".h-subtitle p").length && n(".typed-subtitle").each(function() {
            n(this).typed({
            ...
            n(".h-subtitles").addClass("ready"), n(".typed-bread").length && n(".typed-bread").typed({
        ...
        var a = location.hash,
            t = n(a);
        if (0 == a.indexOf("#section-") && t.length && n("body, html").animate({
            scrollTop: n(a).offset().top - 68
        }, 400), n(".jarallax").length && n(".jarallax").jarallax(), n(".started-carousel").length) {
            ...
            i.on("slideChange", function() {
                var t = i.realIndex,
                    s = i.slides.length;
                n(".started-carousel .swiper-slide").removeClass("first"), n(".started-carousel .swiper-slide").each(function(e, a) {
        ...
        if (n(".reviews-carousel").length) new Swiper(".reviews-carousel .swiper-container", {
            loop: !0,
            spaceBetween: 70,
            slidesPerView: 2,
            autoplay: {
    ...
    var e = n(window).width(),
        a = n(window).height();
    if (n(".section.started").css({
        height: a
    }), n(".logged-in .section.started").css({
        height: a - 32
    }), e < 783 && (n(".section.started").css({
        height: a
    }), n(".logged-in .section.started").css({
        height: a - 46
    ...
    1199 < e && (n(document).on("mousemove", function(e) {
        ...
        mouseenter: function(e) {
            n(".cursor-follower").stop().animate({
                width: 86,
                height: 86,
                opacity: .1,
        ...
        mouseenter: function(e) {
            ...
            a.css({
                top: i + "px",
                left: s + "px"
            }).addClass("ink-animate"), n(".cursor-follower").addClass("hide")
        },
        mouseleave: function(e) {
            var a = n(this).find(".ink"),
            ...
            a.css({
                top: s + "px",
                left: t + "px"
            }).removeClass("ink-animate"), n(".cursor-follower").removeClass("hide")
        }
    }), n("header .top-menu, .typed-bread, .popup-box .bts, .animate-to-page").on("click", "a", function() {
        var e = n(this).attr("href");
        return 0 == e.indexOf("#section-") ? (n("body").hasClass("home") || (location.href = "/" + e), n("body, html").animate({
            scrollTop: n(e).offset().top - 68
        }, 400), n("header").hasClass("active") && n(".menu-btn").trigger("click")) : (n(".lines").removeClass("finish"), n(".lines").removeClass("ready"), n(".lines").addClass("no-lines"), setTimeout(function() {
            location.href = "" + e
        }, 2500)), !1
    }), n(window).on("scroll", function() {
        n(this).scrollTop() >= n(".section.started").height() ? n("body").removeClass("background-enabled") : !n("header").hasClass("active") && n(".video-bg").length && n("body").addClass("background-enabled"), 100 <= n(this).scrollTop() && 1 < n(".section").length && (n(".header").addClass("fixed"), n(".footer").addClass("fixed"), n(".mouse_btn").fadeOut()), n(this).scrollTop() <= 100 && 1 < n(".section").length && (n(".header").removeClass("fixed"), n(".footer").removeClass("fixed"), n(".mouse_btn").fadeIn())
    }), n("header").on("click", ".menu-btn", function() {
        return n("header").hasClass("active") ? (n("header").removeClass("active"), n(".footer .soc").fadeIn(), n("body").addClass("loaded"), n(".video-bg").length && n("body").addClass("background-enabled")) : (n("header").addClass("active"), n(".footer .soc").hide(), n("body").removeClass("loaded"), n("body").removeClass("background-enabled")), !1
    ...
    t.imagesLoaded(function() {
        ...
        t.isotope({
            filter: e
        }), n(".filters .btn-group label").removeClass("glitch-effect"), n(this).find("label").addClass("glitch-effect")
    }), /\.(?:jpg|jpeg|gif|png)$/i.test(n(".gallery-item:first a").attr("href")) && n(".gallery-item a").magnificPopup({
        gallery: {
            enabled: !0
        },
        type: "image",
    ...
    var s = /^((?!chrome|android).)*safari/i.test(navigator.userAgent),
        i = !1;
    /(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent) && (i = !0), n(".video-bg").length && (n("body").addClass("background-enabled"), i ? n(".video-mobile-bg").each(function() {
        n(this).css("background-image", "url(" + n(this).data("mobile-preview") + ")")
    }) : n(".jarallax-video").length && n(".jarallax-video").each(function() {
        var e = n(this).data("volume");
        s || n(this).jarallax({
            videoVolume: e
        }), s && n(this).jarallax()
    })), n(".section").length && n(".top-menu li a").length && n(window).on("scroll", function() {
        ...
        var e = n(".skills.dotted .progress"),
            a = e.width();
        e.length && (e.append('<span class="dg"><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span></span>'), e.find(".percentage").append('<span class="da"><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span><span></span></span>'), e.find(".percentage .da").css({
            width: a
        }))
    }, 1e3);
    var o = n(".skills.circles .progress");
    o.length && o.append('<div class="slice"><div class="bar"></div><div class="fill"></div></div>'), n(window).resize(function() {
        var e = n(window).width(),
            a = n(window).height();
        n(".section.started").css({
            height: a
        }), e < 783 && n(".section.started").css({
            height: a
        });
